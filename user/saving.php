...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- <li class="nav-item">
				<a class="nav-link" href="https://drive.google.com/file/d/1lJ8sagwROu541elWUq498z3teK6_gF2e/view?usp=share_link">
				<i class="fa fa-download" aria-hidden="true"></i>

					<span>Application for Bonus Loan</span></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="https://drive.google.com/file/d/1q1qUvePm5rC4kST2KAYpuzNGrp5aBP3q/view?usp=share_link">
				<i class="fa fa-download" aria-hidden="true"></i>

					<span>Application for Allowance Loan</span></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="https://drive.google.com/file/d/1EqoggKO5WfpxNlYFc5CVNxx4ZuanEcqw/view?usp=share_link">
				<i class="fa fa-download" aria-hidden="true"></i>
					<span>Application for Loan with Travel Loan</span></a>
			</li> -->
...
<li class="nav-item dropdown no-arrow">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Savings Account List</h1>
					</div>
