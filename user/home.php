...
<li class="nav-item dropdown no-arrow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card p-2 text-center h3" style="margin-left:20%; width: 60%;">
                        Announcements
                    </div>
                    <?php
										...
										?>
                    <div class="card p-2 text-center mb-4" style="margin-left:20%; width: 60%;">
                    <?php echo $fetch['announcement_details']; 
                        echo "<br> Created : ".$fetch['announcement_date'];
                        if (str_ends_with($fetch['img'], 'pdf')) {
                            ?>
                            <embed src="../image/src/<?php echo $fetch['img']; ?>#toolbar=0&navpanes=0&scrollbar=1" type="application/pdf" width="100%" height="1000px"/>
                            <?php
                        }
                        if (str_ends_with($fetch['img'], 'jpg') || str_ends_with($fetch['img'], 'jpeg') || str_ends_with($fetch['img'], 'gif') || str_ends_with($fetch['img'], 'png')) {
                            ?>
                            <img src="../image/src/<?php echo $fetch['img']?>"  style="margin-left:25%; width: 50%;">
                            <?php
                        }
                    ?>
