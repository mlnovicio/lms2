...
<li class="nav-item dropdown no-arrow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        <div class="container-fluid">
                            <div class="col-md text-center"><a style="cursor: pointer;" id="seeall" class="text-warning">See all message</a></div>
                            <div id="chathis">
                        ...
                        notClick(500)
                         ...
                         function notClick(timer){ $(function() {
                        ...
                        $('#seeall').click(function(){
                            ...
                            <div class="row pt-4">
                                <div class="col-sm-11">
                                    ...
                                    <input type="text" name="send" placeholder="Input Message to admin.." class="form-control">
                                </div>
                                <div class="col-sm-1">
                                    <button type="submit" id="subm" name="sendMessage" class="form-control">Send</button>
                                    </form>
                                </div>
                            </div>
