                                    ...
                                    <form method="POST" class="user" action="login.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="username"
                                                placeholder="Enter Username here..." required="required">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <p>Don't have an account? <a href="register_form.php" target="_blank">Register now
                                                <action="register_form.php">
                                                    <src="LMS /register/register_form.php">
                                            </a></p>
                                            <a href="forgot_password.php" target="_blank">forgot password? 
                                            </a>
