            ...
            <div class="container border shadow my-5 p-4 bg-white">
               ...
               <div> 
                  ...
                  <div style="display: inline-block; min-width: 500px;">
                     <input type="text" name="amount1" class="w-100 line-input" style="border: none; border-bottom: 1px solid black; padding: 0">
                  </div>(P
                  <div style="display: inline-block; min-width: calc(100% - 1100px);">
                     <input type="text" name="amount2" class=" line-input" style="border: none; border-bottom: 1px solid black; padding: 0">
                  ...
                  <div style="display: inline-block;max-width: 50px">
                     <input type="text"  name="date1"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>day of
                  <div style="display: inline-block;max-width: 200px">
                     <input type="text"  name="date2" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>, 20  <div style="display: inline-block;max-width: 50px">
                     <input type="text"  name="date3" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>.
                  <br>
                  <br>
                  <br>
                  ...
                  <div style="display: inline-block;min-width: 500px">
                     <input type="text" name="printed_name" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;" required>
                  </div><br>
               ...
               <div style="color:black">
                  ...
                  Name:<div style="display: inline-block;min-width: 1035px">
                     <input type="text"  name="name"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;" required>
                  </div>
                  ...
                  Date of birth:<div style="display: inline-block;min-width: 500px">
                     <input type="date" onchange="date_age()" name="bday" id="bday"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;"> <script type="text/javascript"> 
                        function date_age(){
                     const currentDate = new Date();

                     // Create a new Date object for the specific date to subtract ("2016-01-01")
                     const specificDate = new Date(""+document.getElementById('bday').value);

                     // Calculate the difference between the two dates in milliseconds
                     const difference = currentDate.getTime() - specificDate.getTime();

                     // Convert the difference to years
                     const yearsDifference = Math.floor(difference / (1000 * 60 * 60 * 24 * 365.25));

                     // Display the difference in years
                     ...
                     <input type="number"  name="age" id="age"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;" readonly>
                  </div>
                  Gender:<div style="display: inline-block;min-width: 100px;max-width: 100px">
                     <input type="text"  name="gender" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Civil Status:<div style="display: inline-block;min-width: 200px">
                     <input type="text" name="civil_status"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  ...
                  Department:<div style="display: inline-block;min-width: 500px">
                     ...
                     <input type="number" name="salary"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Other Source of Income (specify):<div style="display: inline-block;min-width: 500px">
                     ...
                     <input type="number" name="monthly_income"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  ...
                  No. of Dependents:<div style="display: inline-block;min-width: 100px;max-width:100px">
                     <input type="text"  name="dependents"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  ...
                  Tin:<div style="display: inline-block;min-width: 255px">
                     <input type="text" name="tin"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  <br>
                  ******************************************************************************************************************************************************
                  ...
                  on<div style="display: inline-block;min-width: 255px">
                     <input type="text"  name="input1" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>under BOD Resolution No.<div style="display: inline-block;min-width: 50px;max-width: 50px">
                     <input type="text" name="input2"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>s,<div style="display: inline-block;min-width: 105px;max-width: 105px">
                     <input type="text" name="input3" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div><br>
                  Membership No.<div style="display: inline-block;min-width: 150px;max-width: 150px">
                     <input type="text" name="input4" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  <br>
                 <center>
                  <div style="display: inline-block;min-width: 350px;max-width: 350px">
                     <input type="text" name="secretary" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div><br>
                    Secretary
                  </center>
                  <br>
