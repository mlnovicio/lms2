...
where membership_id = ".$_COOKIE['membership_id']."";
         ...
         <div id="content">
            ...
            <div class="container border shadow my-5 p-4 bg-white">
               ...
               <div class="text-center mt-4 bg-yellow-green">
                  <b class="text-black p-0 m-0">MEMBERSHIP SUBSCRIPTION AGREEMENT
...
<br>
               ...
               <div>
                  ...
                  <div style="display: inline-block; min-width: 500px;">
                     <input type="text" name="amount1" value="<?php echo $row['amount1']?>" class="w-100 line-input" style="border: none; border-bottom: 1px solid black; padding: 0">
                  </div>(P
                  <div style="display: inline-block; min-width: calc(100% - 1100px);">
                     <input type="text" name="amount2"  value="<?php echo $row['amount2']?>"  class=" line-input" style="border: none; border-bottom: 1px solid black; padding: 0">
                  ...
                  <div style="display: inline-block;max-width: 50px">
                     <input type="text"  name="date1"    value="<?php echo $row['date1']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>day of
                  <div style="display: inline-block;max-width: 200px">
                     <input type="text"  name="date2"  value="<?php echo $row['date2']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>, 20  <div style="display: inline-block;max-width: 50px">
                     <input type="text"  name="date3"  value="<?php echo $row['date3']?>" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>.
                  <br>
                  <br>
                  <br>
                  ...
                  <div style="display: inline-block;min-width: 500px">
                     <input type="text" name="printed_name"  value="<?php echo $row['printed_name']?>" class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;text-align: center;" required>
                  </div><br>
               ...
               <div style="color:black">
                  ...
                  Name:<div style="display: inline-block;min-width: 1035px">
                     <input type="text"  name="name"  value="<?php echo $row['name']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;" required>
                  </div>
                  Email:<div style="display: inline-block;min-width: 1040px">
                     <input type="email"  name="email" value="<?php echo $row['email']?>"   class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;" required>
                  </div>
                  Address:<div style="display: inline-block;min-width: 1020px">
                     <input type="text"  name="address" value="<?php echo $row['address']?>"   class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Date of birth:<div style="display: inline-block;min-width: 500px">
                     <input type="text" name="bday"  value="<?php echo $row['bday']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Place of Birth:<div style="display: inline-block;min-width: 250px">
                     <input type="text"  name="bplace"  value="<?php echo $row['bplace']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Age:<div style="display: inline-block;min-width: 20px;max-width: 105px">
                     <input type="number"  name="age" value="<?php echo $row['age']?>"   class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Gender:<div style="display: inline-block;min-width: 100px;max-width: 100px">
                     <input type="text"  name="gender" value="<?php echo $row['gender']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Civil Status:<div style="display: inline-block;min-width: 200px">
                     <input type="text" name="civil_status"  value="<?php echo $row['civil_status']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>if married; husband/wife Name/B-day:<div style="display: inline-block;min-width: 365px;max-width: 365px">
                     <input type="text" name="married_info"  value="<?php echo $row['married_info']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Highest Educational Attainment:<div style="display: inline-block;min-width: 850px">
                     <input type="text" name="education"  value="<?php echo $row['education']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Department:<div style="display: inline-block;min-width: 500px">
                     <input type="text" name="department"  value="<?php echo $row['department']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Position:<div style="display: inline-block;min-width: 250px">
                     <input type="text" name="position"  value="<?php echo $row['postion']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Salary:<div style="display: inline-block;min-width: 130px;max-width: 130px">
                     <input type="number" name="salary"  value="<?php echo $row['salary']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Other Source of Income (specify):<div style="display: inline-block;min-width: 500px">
                     <input type="text" name="other_source"  value="<?php echo $row['other_source']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Monthly Income:<div style="display: inline-block;min-width: 215px;max-width: 215px">
                     <input type="number" name="monthly_income"  value="<?php echo $row['monthly_income']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Nearest Relative:<div style="display: inline-block;min-width: 500px">
                     <input type="text"  name="nearest_relative"  value="<?php echo $row['nearest_relative']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Relationship:<div style="display: inline-block;min-width: 365px;max-width: 365px">
                     <input type="text" name="relation"  value="<?php echo $row['relation']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  No. of Dependents:<div style="display: inline-block;min-width: 100px;max-width:100px">
                     <input type="text"  name="dependents"  value="<?php echo $row['dependents']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>Religion/Social Affiliation:<div style="display: inline-block;min-width: 657px;max-width: 657px">
                     <input type="text" name="religion" value="<?php echo $row['religion']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Name of Dependents and Date of Birth:<div style="display: inline-block;min-width: 795px">
                     <input type="text"  name="name_dependents" value="<?php echo $row['name_dependents']?>"   class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  Tin:<div style="display: inline-block;min-width: 255px">
                     <input type="text" name="tin"  value="<?php echo $row['tin']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  <br>
                  ******************************************************************************************************************************************************
                  ...
                  on<div style="display: inline-block;min-width: 255px">
                     <input type="text"  name="input1"  value="<?php echo $row['input1']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>under BOD Resolution No.<div style="display: inline-block;min-width: 50px;max-width: 50px">
                     <input type="text" name="input2"   value="<?php echo $row['input2']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>s,<div style="display: inline-block;min-width: 105px;max-width: 105px">
                     <input type="text" name="input3" value="<?php echo $row['input3']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div><br>
                  Membership No.<div style="display: inline-block;min-width: 150px;max-width: 150px">
                     <input type="text" name="input4"  value="<?php echo $row['input4']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div>
                  <br>
                 <center>
                  <div style="display: inline-block;min-width: 350px;max-width: 350px">
                     <input type="text" name="secretary"  value="<?php echo $row['secretary']?>"  class="w-100 line-input " style="border: none; border-bottom: 1px solid black; padding: 0;">
                  </div><br>
                    Secretary
                  </center>
                  <br>
              ...
              <br>
               ...
               <div class="text-center w-100 mb-5 pb-5">
                  <button onclick="generatePDF()" type="button" class="btn btn-success px-5"><i class="fas fa-download"></i></button>
                  <br><br>
               </div>
            </div>
            </form>
